...
def page1():
    ...
    session_state.V_gBurn = st.number_input('Volume of Gas burn as % of biogas produced',0,1,value = session_state.V_gBurn)
    ...
    session_state.debt_level = st.number_input('Debt level of the project',0,1,value = session_state.debt_level)
    session_state.V_cng_p = st.number_input('Volume of Gas upgraded to biodiesel for manure transportation: ',0,1,value = session_state.V_cng_p)
